...
n_repetitions           = 1;  % number of repeats of all direction/SF/TF combinations
                              ...
                              % number of stimuli)
n_stim_per_session      = 128;  % number of stimuli to present each time we press GRAB in Scanimage
                               % MUST DIVIDE n_directions * # spatial
                               % frequencies * # temporal frequencies * #
                               % n_repetitions.
n_baseline_triggers     = 0;  % the number of triggers to wait at the beginning and end of stimulus sequence
